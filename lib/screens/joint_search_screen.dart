...
class _JointSearchScreen
    extends ConsumerState<JointSearchScreen> {
...
// TextEditingControllers for data inputs
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: _userType == UserType.client ? const Text("Search Projects") : const Text("Search Requests"), actions: [
        IconButton(
          ...
          Future<void> _onPressedFunction() async {
            ...
            try {
              ...
              if (_userType == UserType.client) {
                ...
                Navigator.pushReplacementNamed(
                    context, "/VendorFilteredRequestListScreen", arguments: mySearch);
              }
            } catch (error) {
                      ...
                      children: [const SizedBox(
                        ...
                        Container(
                          ...
                          child: _isLoading
                            ...
                            child: _userType == UserType.client ? const Text(
                              'Filter Projects',
