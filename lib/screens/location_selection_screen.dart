...
class LocationSelectionScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LocationSelectionScreen> createState() => _LocationSelectionScreen();
}
    ...
    _location.onLocationChanged.listen((l) {
      ...
      _controller?.animateCamera(
        CameraUpdate.newCameraPosition(
          lat == null ? CameraPosition(target: LatLng(l.latitude!, l.longitude!),zoom: 15):CameraPosition(target: LatLng(lat!, lng!),zoom: 15),
        ),
      );
    });
  }
      ...
      child: Stack(
        children: [
          GoogleMap(
            ...
            markers: <Marker>{ // taken from https://stackoverflow.com/questions/55003179/flutter-drag-marker-and-get-new-position
              Marker(
                  onTap: () {
                    print('Tapped');
                  },
