...
class _ClientRequestDetailsScreen
    ...
    if (doneOnce == false) {
      ...
      ref.watch(requestProvider).getRequestById(_requestId).then((value) {
        ...
        if (initialRequest!.requestLat != null) {
          ...
          ref.read(requestLatLngProvider.notifier).state = currentUserLocation;
        }

        if (initialRequest?.requestMinCost != null &&
            initialRequest?.requestMaxCost != null) {
          ref.read(requestCostProvider.notifier).state = RangeValues(
              initialRequest!.requestMinCost!.toDouble(),
        ...
        if (initialRequest?.requestCreatedDay != null) {
          ...
          ref.read(requestDateProvider.notifier).state = <DateTime?>[
            initialDate
          ];
        }
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: _isLoading
                                                  ...
                                                  : MaterialButton(
                                                      onPressed:
                                                          _onPressedViewResponsesFunction,
                                                      textColor:
                                            ...
                                            if (_advancedStatus ==
                                                AdvancedStatus.advanced)
                                              MyRequestCostRange(
                                                requestMinCost: initialRequest
                                                    ?.requestMinCost,
                                                requestMaxCost: initialRequest
                                                    ?.requestMaxCost,
                                              ),
                                            if (_advancedStatus ==
                                                AdvancedStatus.advanced)
