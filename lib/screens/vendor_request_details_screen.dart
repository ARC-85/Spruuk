...
class VendorRequestDetailsScreen extends ConsumerStatefulWidget {
  ...
  const VendorRequestDetailsScreen({Key? key}) : super(key: key);

  @override
  _VendorRequestDetailsScreen createState() => _VendorRequestDetailsScreen();
}

class _VendorRequestDetailsScreen
...
// TextEditingControllers for data inputs
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Client Request Details"), actions: [
        IconButton(
