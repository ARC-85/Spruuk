...
class VendorResponseDetailsScreen extends ConsumerStatefulWidget {
  ...
  const VendorResponseDetailsScreen({Key? key}) : super(key: key);
    ...
    if (doneOnce == false) {
      ...
      ref.watch(responseProvider).getResponseById(_responseId).then((value) {
        setState(() {
          ...
          _responseTitle.text = initialResponse!.responseTitle;
          if (initialResponse?.responseDescription != null) {
            _responseDescription.text = initialResponse!.responseDescription!;
          }
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _onPressedFunction() async {
      ...
      try {
        ...
        await _responseProvider.updateResponse(ResponseModel(
          responseId: initialResponse!.responseId,
          responseTitle: _responseTitle.text,
          responseDescription: _responseDescription.text,
          responseUserId: initialResponse!.responseUserId,
          responseUserFirstName: initialResponse!.responseUserFirstName,
          responseUserLastName: initialResponse!.responseUserLastName,
          responseUserEmail: initialResponse!.responseUserEmail,
          responseUserImage: initialResponse!.responseUserImage,
          responseRequestId: initialResponse!.responseRequestId,
          responseCreatedDay: initialResponse!.responseCreatedDay,
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Update Response"), actions: [
        IconButton(
